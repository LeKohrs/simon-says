...
new Vue({
    ...
    methods: {
        ...
        muteMusic: function() {
            let mainMusic = document.getElementsByClassName('main-music')[0]
        ...
        playWrong: function() {
            ...
            play.setAttribute('src', '_ui/skin/src/audio/aww.mp3');
            play.play();
        },
        playPing: function() {
            var correctplay = document.createElement('audio');
            correctplay.setAttribute('src', '_ui/skin/src/audio/bing.mp3');
            correctplay.play();
        },
        animateIn: function() {
            let fruit = document.getElementsByClassName('fruit');
            let delay = fruit.length * 1000 + 1000;
            
            let tl = new TimelineMax();
            tl.set(fruit, {x: 500, opacity: 0})
            .staggerTo(fruit, .7, { x: 0, opacity: 1 }, .7)
            .staggerTo(fruit, .5, {x: -500, opacity: 0, delay: 1.5});
            setTimeout(() => {
                this.playGame();
            }, delay);
        },
...
function createParticles(x, y) {
    ...
    audioplay.setAttribute('src', '_ui/skin/src/audio/firework_5.mp3');
    audioplay.play();
